      ...
      >
        <AnimatePresence initial={false} mode="popLayout">
          {visibleLogos.map(({ logo, originalIndex, position }) => {
            ...
            else if (position === -1 || position === 1) lineOpacity = 0.3;
            ...
            return (
              ...
              >
                ...
                >
                  <div className="w-0.5 h-6 mb-4 bg-border" />
                  <span className="text-muted-foreground uppercase text-lg font-medium tracking-wider whitespace-nowrap">
                    {logo.label}
                  </span>
                </motion.div>
              </motion.div>
